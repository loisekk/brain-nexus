...
description: >-
  Covers TypeScript 5+, React 18+, Next.js 14+ App Router, Zustand, Tailwind CSS,
  and Vitest testing. Use when writing TypeScript applications, React components,
  or Node.js services. Not for UI/UX design (use interface-design), database schema
  (use database-design), or Python (use python-development).
---
